...
class RepositoryIndexer {
    ...
    async findFilesToIndex() {
        const patterns = this.config.includePatterns.map(pattern => path.join(this.config.repositoryPath, pattern));
    ...
    async buildFileDepGraph(filePath, nodes, edges, maxDepth, currentDepth, includeExternal) {
